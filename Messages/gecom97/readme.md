...
> **Nota importante:** Cada mensaje contiene exclusivamente registros de recepción (`statusReceptionOrders`) **o** de expedición (`statusDeliveryOrders`), nunca ambos a la vez. El ERP debe gestionar ambos arrays de forma independiente.
